...
<div style="float:left;">
    ...
    <table  style="float: left;">
        ...
        <?php
        $info = mysqli_query($conn, "SELECT * FROM `g1` INNER JOIN `tablo1` using (lot) WHERE `g1`.`uid`=1 AND `lot` !=0 AND `cid` = '$z' AND `qid` = '$z'  AND `gendage` LIKE '$g' AND `wc` = '$w' ORDER BY `g1`.`lot` ASC ");
        ...
        <tr>
            ...
            ?>
            <?php
            $info = mysqli_query($conn, "SELECT * FROM `g1` INNER JOIN `tablo1` using (lot) WHERE `g1`.`uid`=3 AND `lot` !=0 AND `cid` = '$z' AND `qid` = '$z'  AND `gendage` LIKE '$g' AND `wc` = '$w' ORDER BY `g1`.`lot` ASC ");
    ...
    <table>
        ...
        <?php
        $info1 = mysqli_query($conn, "SELECT * FROM `g1` INNER JOIN `tablo1`  using (lot) WHERE `g1`.`uid`= 2 AND `lot` !=0 AND `cid` = '$z' AND `qid` = '$z'  AND `gendage` LIKE '$g' AND `wc` = '$w' ORDER BY `g1`.`lot` ASC  ");
...
<!--    <a href="../scripts/lone1C.php?r=3&w=--><?//=$w?><!--&g=--><?//=$g?><!--&q=--><?//= $q ?><!--&z=--><?//= $z ?><!--&id=2&n=2&sr=--><?//= $sr ?><!--" class="button">END Round</a>-->
