...
<!--            <td id="no"></td>-->
        ...
        <tr>
            <th colspan="8" id="no">M.Referee:<?= $e ?></th>
...
<!--            <td id="no"></td>-->
<!--            <td id="no"></td>-->
<!--            <td id="no"> <a href="../scripts/updC.php?l=a&x=1&y=3&n=2&w=--><?//=$w?><!--&g=--><?//=$g?><!--&q=--><?//=$q?><!--&z=--><?//=$z?><!--&sr=--><?//= $sr ?><!--&cc=--><?//= $cc ?><!--&t=3">Update</a> </td>-->
            </tr>
...
<!--            <td id="no"></td>-->
<!--            <td id="no"></td>-->
<!--            <td id="no"> <a href="../scripts/updC.php?l=a&x=2&y=4&n=2&w=--><?//=$w?><!--&g=--><?//=$g?><!--&q=--><?//=$q?><!--&z=--><?//=$z?><!--&sr=--><?//= $sr ?><!--&cc=--><?//= $cc ?><!--&t=3">Update</a> </td>-->
            </tr>
...
<!--    <a href="../scripts/lone1C.php?r=4&w=--><?//=$w?><!--&g=--><?//=$g?><!--&q=--><?//= $q ?><!--&z=--><?//= $z ?><!--&id=3&n=3&sr=--><?//= $sr ?><!--&cc=--><?//= $cc ?><!--" class="button">END Round</a>-->
