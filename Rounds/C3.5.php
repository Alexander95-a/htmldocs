...
<!--            <td></td>-->
<!--            <td></td>-->
            <td id="no"> <a href="../scripts/updC.php?l=c&x=4&y=1&n=3&w=<?=$w?>&g=<?=$g?>&q=<?=$q?>&z=<?=$z?>&sr=<?= $sr ?>&cc=<?= $cc ?>&t=3">Update</a> </td>
            </tr>
...
<!--            <td></td>-->
<!--            <td></td>-->
            <td id="no"> <a href="../scripts/updC.php?l=c&x=5&y=2&n=3&w=<?=$w?>&g=<?=$g?>&q=<?=$q?>&z=<?=$z?>&sr=<?= $sr ?>&cc=<?= $cc ?>&t=3">Update</a> </td>
            </tr>
