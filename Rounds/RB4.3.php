...
<header>
    ...
    if($s2==1){
        ...
        header("Location:../Rounds/RB4.3.php?w=$w&g=$g&q=$q&z=$z&s2=$s2&m=$m");
    }
...
<div style="margin: auto">
    ...
    <table>
        ...
        <?php
        $info1 = mysqli_query($conn, "SELECT * FROM `cb` where  uid= 5 ORDER BY `cb`.`id` ASC  ");
        ...
        foreach ($info1 as $info1){
            ...
            <td><a href="RB4.3.php?w=<?=$w?>&g=<?=$g?>&q=<?= $q ?>&z=<?= $z ?> &ch1=red&ch2=<?= $ch2 ?>&ch3=<?= $ch3 ?>&ch4=<?= $ch4 ?>&o1=<?=$info1[0]?>&m=<?= $m ?>&s2=<?= $s2 ?>" class="button">1</a></td>
            <td><a href="RB4.3.php?w=<?=$w?>&g=<?=$g?>&q=<?= $q ?>&z=<?= $z ?> &ch2=red&ch1=<?= $ch1 ?>&ch4=<?= $ch4 ?>&ch3=<?= $ch3 ?>&o1=<?=$info1[0]?>&m=<?= $m ?>&s2=<?= $s2 ?>" class="button">2</a></td>
            </tr>
        ...
        ?>
        <?php
        $info0 = mysqli_query($conn, "SELECT * FROM `cb` where uid = 6 ORDER BY `cb`.`id` ASC  ");
        ...
        foreach ($info0 as $info0){
            ...
            <td><?=$info0[2]?></td>
            <td><?=$info0[3]?></td>
            <td><a href="RB4.3.php?w=<?=$w?>&g=<?=$g?>&q=<?= $q ?>&z=<?= $z ?> &ch3=red&ch2=<?= $ch2 ?>&ch1=<?= $ch1 ?>&ch4=<?= $ch4 ?>&o2=<?=$info0[0]?>&m=<?= $m ?>&s2=<?= $s2 ?>&o1=<?=$info1[0]?>" class="button">1</a></td>
            <td><a href="RB4.3.php?w=<?=$w?>&g=<?=$g?>&q=<?= $q ?>&z=<?= $z ?> &ch4=red&ch2=<?= $ch2 ?>&ch1=<?= $ch1 ?>&ch3=<?= $ch3 ?>&o2=<?=$info0[0]?>&m=<?= $m ?>&s2=<?= $s2 ?>&o1=<?=$info1[0]?>" class="button">2</a></td><!-- команда-->
        ...
        <tr>
            <th colspan="8"><a href="RB4.3.php?w=<?=$w?>&g=<?=$g?>&q=<?= $q ?>&z=<?= $z ?>&m=<?= $m ?> &ch1=yellow&ch2=yellow&ch3=yellow&ch4=yellow&o1=<?=$info1[0]?>&o2=<?=$info0[0]?>" class="button">restart</a></th>

        </tr>

        <div class="button-box">

        <a href="RB4.3.php?w=<?=$w?>&g=<?=$g?>&q=<?= $q ?>&z=<?= $z ?> &m=1&o1=<?=$info1[0]?>&ch1=<?= $ch1 ?>&ch2=<?= $ch2 ?>&ch3=<?= $ch3 ?>&ch4=<?= $ch4 ?>" class="button2">stop</a>
        <a href="RB4.3.php?w=<?=$w?>&g=<?=$g?>&q=<?= $q ?>&z=<?= $z ?> &m=3&o1=<?=$info1[0]?>&ch1=<?= $ch1 ?>&ch2=<?= $ch2 ?>&ch3=<?= $ch3 ?>&ch4=<?= $ch4 ?>" class="button2">start</a>
        <a href="RB4.3.php?w=<?=$w?>&g=<?=$g?>&q=<?= $q ?>&z=<?= $z ?> &m=2&o1=<?=$info1[0]?>&ch1=<?= $ch1 ?>&ch2=<?= $ch2 ?>&ch3=<?= $ch3 ?>&ch4=<?= $ch4 ?>" class="button2">reset</a>
        </div>
        ...
        <form action="RB4.3.php" method="Get">
