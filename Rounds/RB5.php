...
<body>
<form action="RB5.php" method="Get">
...
<div style="float:left;">
                                                    ...
                                                    ?>
                                                        ...
                                                        <?php
                                                            ...
                                                            <?php
                                                                ...
                                                                ?>"> 
                                                                <a href="../scripts/updB2.php?l=<?=$l?>&id=<?= $info1["uid"] ?>&n=<?=$n?>&w=<?=$w?>&g=<?=$g?>&q=<?=$q?>&z=<?=$z?>&sr=<?=$sr?>&t=3" class="link">Update</a> </td>
                                                                <?php
                                                            }
                                                ?>
    ...
    <a href="../Rounds/RA3.php?l=a&n=<?=$n?>&w=<?=$w?>&g=<?=$g?>&q=<?= $q ?>&z=<?= $z ?>&sr=<?=$sr?>" class="add">Завершить раунд</a>
    <!--    <p>--><?//= $l ?><!--</p>-->
    <!--    <p>--><?//= $cc ?><!--</p>-->
    <!--    <p>--><?//= $kk ?><!--</p>-->
