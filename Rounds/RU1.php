                            ...
                            <td  style="background: #ffffff; vertical-align: top; padding: 1px;">
                                ...
                                <table width="600" style="float: right;">
                                    ...
                                    <tr>
                                        ...
                                        <?php
                                        $info = mysqli_query($conn, "SELECT * FROM `u1` INNER JOIN `tablo1` using (lot) WHERE `u1`.`uid` % 2 <> 0 AND `lot` !=0 AND `cid` = '$z' AND `qid` = '$z'  AND `gendage` LIKE '$g' and `qga` like '$g' AND `wc` = '$w' and `qwc` = '$w'  ORDER BY `u1`.`lot` ASC ");
                        ...
                        <div> 
                            <td style="background: #ffffff; vertical-align: top ; padding: 1px;">   
                                <table width="700" style="float: left;">
                                    ...
                                    <?php
                                    $info1 = mysqli_query($conn, "SELECT * FROM `u1`  INNER JOIN `tablo1`  using (lot) WHERE `u1`.`uid` % 2 = 0 AND `lot` !=0 AND `cid` = '$z' AND `qid` = '$z'  AND `gendage` LIKE '$g' and `qga` like '$g' AND `wc` = '$w' and `qwc` = '$w'  ORDER BY `u1`.`lot` ASC ");
                                    foreach ($info1 as $info1) {
                                        ...
                                        <td 
                                                <?php 
                                                    $jr = $info1['lot'];
                                                    $info2 = mysqli_query($conn, "SELECT * FROM `u1` INNER JOIN `tablo1` using (lot) WHERE `u1`.`lot`= '$jr'  AND `cid` = '$z' AND `qid` = '$z'  AND `gendage` LIKE '$g' AND `wc` = '$w'");
                                                    $info2 = mysqli_fetch_assoc($info2);
                                                    $jq = $info2["R1"];
                                                    $cn = $info2["L1"];
                                                        ?>
                                                        ...
                                                        if($cn == 2 || $jq == 2 ){?>
                                                            ...
                                                            ?>"> <a href="../scripts/updateU.php?l=U1&id=<?= $info1['lot'] ?>&n=1&w=<?=$w?>&g=<?=$g?>&q=<?=$q?>&z=<?=$z?>&sr=<?=$sr?>&t=3" class="link">Update</a>  
                                        </td>
                                                <?php
                                                }
                                                ?>
                                ...
                                <a href="../Rounds/RU2.php?r=3&w=<?=$w?>&g=<?=$g?>&q=<?= $q ?>&z=<?= $z ?>&n=2&sr=<?=$sr?>&l=u" class="button" style="align: center">Завершить</a>
                            </td>
                        </div> 
                    </div> 
                </tr>
