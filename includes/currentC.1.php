...
$info = mysqli_query($conn, "SELECT * FROM `c$n` INNER JOIN `tablo1` using (lot) WHERE `c$n`.`uid` = '$y' AND `cid` = '$z' AND `gendage` LIKE '$g' AND `wc` = '$w' AND `qid` = '$z' AND `qga` LIKE '$g' AND `qwc` = '$w' ");
$info1 = mysqli_query($conn, "SELECT * FROM `c$n` INNER JOIN `tablo1` using (lot) WHERE `c$n`.`uid` = '$x' AND `cid` = '$z' AND `gendage` LIKE '$g' AND `wc` = '$w' AND `qid` = '$z' AND `qga` LIKE '$g' AND `qwc` = '$w' ");
