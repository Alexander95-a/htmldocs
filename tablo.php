...
$row = mysqli_fetch_assoc($query_run);
    ...
    $tb4= $row['check2'];
    $tm= $row['timer'];
$query = "SELECT * FROM `cb` WHERE `uid` = '2'";
$query_run = mysqli_query($conn, $query);
$row = mysqli_fetch_assoc($query_run);
...
<!-- Сюда надо въебать флаг -->
                    ...
                    <div class="col-6" >
                        ...
                        <div class="count1" style="margin-left: -230px">
                            ...
                            ?>
                            <div id="div3">
                                <div class="holder3" style="width: 550px; text-align: center; white-space: normal;  ">
...
<!--                            </p>-->
            ...
            <div class="col-4">
                <div class="row mt-5">
                    <div class="gender" >
                        <?php
                        $query = "SELECT UPPER (gender) as gender FROM `cb` WHERE `uid` = '1'";
                        $query_run = mysqli_query($conn, $query);
                        $row = mysqli_fetch_assoc($query_run);
                        ?>
                        <p class="mx-auto time my-1 mont" >
            ...
            <div class="col-4">
                <div class="row">
                    <div class="col-6" style=" width: 00px;">
                        <div style="margin-left: -10px">
                            ...
                            ?>
                            <div id="div4">
                                <div class="holder4" style=" width: 500px; text-align: center;  white-space: normal; ">
