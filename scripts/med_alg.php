...
mysqli_query($conn,"DELETE FROM `b$di` WHERE `b$di`.`lot` = '$id'  AND `cid` = '$z' AND `gendage` LIKE '$g' AND `wc` = '$w' ");

/*
 * Переадресация на главную страницу
 */

header("Location:/../scripts/updb3.php?w=$w&g=$g&q=$q&z=$z&n=$di&l=$l&id=$u1");