...
//$result = mysqli_fetch_assoc($result);
//$j= $result ["R$di"];
mysqli_query($conn, "UPDATE `tablo1` SET `RC` = '$score',`OC` = '$uid2' , `Scores` = `R1` + `R2` + `R3` + `R4` + `R5` + `R6` + `R7` + `R8` + `R9` + `R10`, `Wins` = `Scores`, `LC` = '$lose', `lose` = `L1` + `L2` + `L3` + `L4` + `L5` + `L6` + `L7` + `L8` + `L9` + `L10`, `mc` = `RC`  WHERE `tablo1`.`lot` = $id AND `qid` = '$z' AND `qga` LIKE '$g' AND `qwc` = '$w' ");
mysqli_query($conn, "UPDATE `tablo1` SET `RC` = '$lose', `OC` = '$uid1' , `Scores` = `R1` + `R2` + `R3` + `R4` + `R5` + `R6` + `R7` + `R8` + `R9` + `R10`, `Wins` = `Scores`, `LC` = '$score', `lose` = `L1` + `L2` + `L3` + `L4` + `L5` + `L6` + `L7` + `L8` + `L9` + `L10`, `mc` = `RC`  WHERE `tablo1`.`lot` = $id2 AND `qid` = '$z' AND `qga` LIKE '$g' AND `qwc` = '$w' ");
...
//if($total==0)
//{
mysqli_query($conn,"INSERT INTO `u1` (`id`, `uid`, `Name`, `Team`, `lot2`, `lot`, `cid`, `gendage`, `wc` , `uidb`) SELECT NULL,'$uid1', '$N1', '$T1', '$id', '$id', '$z', '$g', '$w','$uidb1' FROM `tablo1` WHERE `RC`= 2 AND `lot` = $id AND `qid` = '$z' AND `qga` LIKE '$g' AND `qwc` = '$w' ");
mysqli_query($conn,"INSERT INTO `u1` (`id`, `uid`, `Name`, `Team`, `lot2`, `lot`, `cid`, `gendage`, `wc` , `uidb`) SELECT NULL,'$uid2', '$N2', '$T2', '$id2', '$id2', '$z', '$g', '$w','$uidb2' FROM `tablo1` WHERE `RC`= 2 AND `lot` = $id2 AND `qid` = '$z' AND `qga` LIKE '$g' AND `qwc` = '$w' ");
...
if($para==1){
    mysqli_query($conn,"UPDATE `tablo1` SET `para` = '$para',`OC` = '$uid2' , `mc` = 'неявка', `PB`= '$di' WHERE `tablo1`.`lot` = $id AND `qid` = '$z' and `qga` = '$g' and `qwc` = '$w' ");
}
if($para==2){
    mysqli_query($conn,"UPDATE `tablo1` SET `para` = '$para',`OC` = '$uid2' , `mc` = 'сн врачом', `PB`= '$di' WHERE `tablo1`.`lot` = $id AND `qid` = '$z' and `qga` = '$g' and `qwc` = '$w' ");
}
if($para1==1){
    mysqli_query($conn,"UPDATE `tablo1` SET `para` = '$para1',`OC` = '$uid1' , `mc` = 'неявка', `PB`= '$di' WHERE `tablo1`.`lot` = $id2 AND `qid` = '$z' and `qga` = '$g' and `qwc` = '$w' ");
}
if($para1==2){
    mysqli_query($conn,"UPDATE `tablo1` SET `para` = '$para1',`OC` = '$uid1' , `mc` = 'сн врачом', `PB`= '$di' WHERE `tablo1`.`lot` = $id2 AND `qid` = '$z' and `qga` = '$g' and `qwc` = '$w' ");
}
...
header("Location:../scripts/updateUC.php?w=$w&g=$g&q=$q&z=$z&id=$id&n=$di&sr=$sr&t=1&ch1=$ch1&ch2=$ch2&ch3=$ch3&ch4=$ch4&o1=$o1");